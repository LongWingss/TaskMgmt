...
namespace TaskMgmt.DataAccess.Migrations
{
    public partial class user : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "GroupId");
                    table.ForeignKey(
                        name: "FK_Invitations_Users_InvitedByUser",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectTaskStatusId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    StatusText = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTasks_ProjectTaskStatuses_CurrentStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_CurrentStatusId",
                table: "ProjectTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTaskStatuses_ProjectId_StatusText",
                table: "ProjectTaskStatuses",
                columns: new[] { "ProjectId", "StatusText" },
                unique: true);
